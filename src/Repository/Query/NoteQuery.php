...
abstract class NoteQuery
{
    ...
    const CREATE_NOTE_QUERY = 'INSERT INTO notes (name, description) VALUES (:name, :description)';
    const UPDATE_NOTE_QUERY = 'UPDATE notes SET name = :name, description = :description WHERE id = :id';
